...
import static com.backbase.assessment.domain.enums.Player.FIRST_PLAYER;
import static com.backbase.assessment.domain.enums.Player.SECOND_PLAYER;

/**
 * Heart of application, represents and encapsulates the Kalah game logical
 * components.
 *
...
public class GameLogic {
	...
	/**
	 * Checks pit where the last stone landed. If the pit is own empty pit captures
	 * this stone and all stones in the opposite pit and puts them in own Kalah.
	 *
	 * @param lastPit
	 * @param game
	 */
	...
	/**
	 * If the game is terminated adds all remained stones to Kalah of each player.
	 *
	 * @param game
	...
	/**
	 * Makes a move of current associated player. Aggregates all necessary
	 * operations.
	 *
	 * @param game
